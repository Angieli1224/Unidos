...
let SugerenciaSchema = new Schema({
   ...
   nombre: { type: String, required: [true, 'Se requiere el "id_usuario" para crear el registro.'] },
   telefono: { type: Number, required: [true, 'Se requiere el "id_usuario" para crear el registro.'] },
